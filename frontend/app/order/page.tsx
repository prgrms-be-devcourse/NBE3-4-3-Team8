...
export default function OrderPage() {
    ...
    if (errorPaymentInfo || !paymentInfo) {
        return <div className="max-w-6xl mx-auto py-8 text-center text-red-500">{errorPaymentInfo}</div>;
    }
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-96 space-y-6">
                        ...
                        <div className="border border-gray-200 rounded p-4">
                            ...
                            <div className="mb-3">
                                <label className="block text-sm font-medium mb-1">도로명주소</label>
                                <input
                                    type="text"
                                    value={roadAddress}
                                    onChange={(e) => setRoadAddress(e.target.value)}
                                    className="border p-2 w-full"
                                    placeholder="예) 서울특별시 비밀구 비밀로 2-11 (101호)"
                                    required
                                />
                            </div>
                            <div className="mb-3">
